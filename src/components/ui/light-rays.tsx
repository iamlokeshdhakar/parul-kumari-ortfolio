...
/**
 * WebGL atmospheric light-ray background. Mounts a canvas only while
 * intersecting the viewport, and tears the GL context down on unmount
 * or whenever a prop that affects the shader/placement changes.
 */
